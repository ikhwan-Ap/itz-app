  ...
  return (
    <div className="flex items-center gap-3">
      <img
        ...
        style={{ width: size, height: size, borderRadius: "50%", boxShadow: "0 0 18px rgba(56, 189, 248, 0.28)" }}
        className="object-cover shrink-0 ring-1 ring-[#38BDF8]/30"
      />
      {showText && (
        <div>
          ...
          <div className="text-[9px] tracking-[0.22em] text-[#38BDF8] mt-1 font-medium uppercase">
