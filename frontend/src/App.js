      ...
      <BrowserRouter>
        <AuthProvider>
          <Routes>
            ...
            <Route path="/payment" element={<PaymentQris />} />
            ...
            <Route path="/app/payment" element={<ProtectedRoute roles={["user"]}><DashboardLayout><PaymentQris /></DashboardLayout></ProtectedRoute>} />
